      ...
      <div className="no-scrollbar mt-3 flex snap-x gap-2 overflow-x-auto pb-0.5">
        {flowStages.map((stage, index) => (
          <Link
            key={stage.href}
            href={stage.href}
            className={`snap-start shrink-0 rounded-lg border px-2.5 py-2 text-[10px] font-semibold uppercase tracking-[0.08em] transition sm:px-3 sm:text-[11px] sm:tracking-[0.12em] ${
              index <= activeIndex
